...
python mosaic_ml.make_dataset.py predict_mosaic -d=$SRCPATH -o=$unlabeled_data
#  python make_images.py $SRCPATH -o=data/svm/2021-10-06/img/total -d=data/svm/2021-10-06/svm_unlabeled.csv
python mosaic_ml.make_images.py $SRCPATH -o=$image_path -d=$unlabeled_data
python mosaic_ml.mosaic_predict.py $unlabeled_data $image_path -m=$MODELPATH -o=$predictions