...
"""Drizzlepac's JSON harvester with minor adaptation for single exposure corruption filenames (revises dataframe index).
...
def get_json_files(search_path=os.getcwd(), 
                   search_patterns = ["*_total_*_svm_*.json"],#["*_svm_*.json", "*_mvm_*.json", "*_cal_qa_*.json"],
